...
parser = argparse.ArgumentParser(
    description='Build and push Forklift index images for a new release',
    epilog='This script is used to assemble and push new index images for a new Forklift release/version. Please ensure you are properly logged in to quay and have enough permissions in target repos prior executing.')
