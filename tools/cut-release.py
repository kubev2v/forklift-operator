...
files = { 1: {'template': 'clusterserviceversion.yaml.j2', 'path': 'bundle/manifests/forklift-operator.clusterserviceversion.yaml'},
          ...
          4: {'template': 'forklift-k8s.yaml.j2', 'path': 'forklift-k8s.yaml'}}

parser = argparse.ArgumentParser(
    description='Prepare a new Forklift project release',
    epilog='This script is used to prepare a new release branch for Forklift, please review changes before submitting PR.')
...
parser.add_argument('--release_prefix', dest='release_prefix', default='release-v', type=str, help='release_prefix is the scheme used for branching project (i.e release-v), default is release-v')
...
render_vars["namespace"] = "konveyor-forklift"
